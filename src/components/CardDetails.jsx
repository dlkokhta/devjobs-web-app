...
const CardDetails = () => {
  ...
  return (
    <div className=" absolute top-[120px] left-0 right-0 text-center px-6 ">
      {allData
        ...
        .map((data) => (
          ...
          <div
            key={data.id}
            className="relative rounded-md bg-[#19202D] flex flex-col justify-center items-center mb-6"
          >
            {/**logo */}
            <div
            ...
            <div className="pt-12 px-[90px] pb-8 flex flex-col gap-6 ">
              ...
              <div>
                <button className="text-[#5964E0] bg-[#202837] font-Kumbh font-bold text-lg py-4 px-5 rounded-md">
                  Company Site
                </button>
              </div>
            </div>
      ...
      {allData
        .filter((data) => data.id === +id)
        .map((data) => (
          <div className="bg-[#19202D] rounded-md pt-10 px-6 flex flex-col">
            <div>
              <div className=" font-Kumbh flex flex-col items-start mb-12 ">
                ...
                {/**2 */}
                <div className="text-white mb-3 font-bold text-xl ">
                  {data.position}
                </div>
                {/**3 */}
              ...
              {/**button */}
              <button className="bg-[#5964E0] text-white py-4 px-[104px] rounded-md mb-8">
                apply now
              </button>
            </div>
            ...
            <div className="">
              ...
              <div>
                ...
                <div>
                  <div className=" text-[#9DAEC2] text-left font-Kumbh font-normal text-base leading-7">
      ...
      <div className="bg-[#19202D]  p-6 mt-16">
